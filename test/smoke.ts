...

{
  ...
  writeContract(root, validContract());
  mkdirSync(join(root, ".pi/plans"), { recursive: true });
  writeFileSync(join(root, ".pi/plans/older.md"), "# Older\n- [ ] task\nAdversarial review\n");
  writeFileSync(join(root, ".pi/plans/branch-slug.md"), "# Branch slug\n- [ ] task\nAdversarial review\n");
...

{
  ...
  writeContract(root, validContract());
  mkdirSync(join(root, ".pi/plans"), { recursive: true });
  writeFileSync(join(root, ".pi/plans/branch-plan.md"), "# Branch plan\n- [ ] task\nAdversarial review\n");
  writeFileSync(join(root, ".pi/plans/recent-plan.md"), "# Recent plan\n- [ ] task\nAdversarial review\n");
